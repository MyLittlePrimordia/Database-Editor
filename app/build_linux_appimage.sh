#!/usr/bin/env bash
# Build a portable "Database_Editor.AppImage".
# Run this ON LINUX (real machine, VM, or CI) — PyInstaller can't
# cross-build a Linux binary from Windows/Mac.
set -e

BIN_NAME="Database_Editor"          # internal binary/AppDir name, no spaces
DISPLAY_NAME="Database Editor"      # human-readable name
...
#    run appimagetool itself (appimagetool ships as an AppImage too) —
